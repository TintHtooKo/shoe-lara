...
<div class=" content-body">
    ...
    <div class="row justify-content-between align-items-center my-3 mx-1">
        <div class="col-6 col-md-2 mb-2 mb-md-0">
                <a href="{{route('Admin#addProductPage')}}" class="btn btn-primary text-white "><i class="fa-solid fa-plus"></i></a>
        </div>
    ...
    <div class="row justify-content-between align-items-center my-3 mx-3">
        <h3 class=" mx-3 ">Total Shoe Products - {{$totalProduct}}</h3>
        <div class="">
            <a href="{{ route('Admin#productList')}}" class=" bg-primary p-2 mx-3 rounded text-white">Show all</a>
            <a href="{{ route('Admin#productList', 'lowAmt') }}" class=" bg-danger p-2 rounded text-white">Show Low stock</a>
        </div>
    </div>
